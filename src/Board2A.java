...
/**
 * This class represents a Board2A that can be used in a collection
 * of solitaire games similar to Elevens.  The variants differ in
 * card removal and the board size.
 */
public abstract class Board2A {
	...
	/**
	 * Creates a new <code>Board2A</code> instance.
	 ...
	 *                    the deck
	 */
	public Board2A(int size, String[] ranks, String[] suits, int[] pointValues) {
		cards = new Card[size];
